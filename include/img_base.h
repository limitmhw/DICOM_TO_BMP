...
//My functions
//my_func.cpp
void getHistogram(RGBQUAD** dataOfBmp_dst, BYTE* histogram_array, DWORD width, DWORD height);
void getHistogram(BYTE** dataOfBmp_gray, BYTE* histogram_array, DWORD width, DWORD height);